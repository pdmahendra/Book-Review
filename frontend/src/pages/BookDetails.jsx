  ...
  return (
    <div className="h-full p-4">
        ...
        <div className="">
          <div className="flex gap-x-8">
            ...
            <img
              ...
              alt=""
              className="h-[15rem] object-contain w-auto rounded-lg"
            />
            <div className="">
              <h1 className="text-2xl font-bold mt-4">{data.title}</h1>
              <p className="text-gray-600 text-sm">by {data.author}</p>
              <p className="mt-4 italic text-sm text-blue-500">{data.genre}</p>
            </div>
          </div>
      ...
      <div className="mt-6">
        <Link
          to={`/submit-review/${id}`}
          className="text-white bg-[#ff6023] p-2 hover:shadow-xl rounded-lg"
        >
          Add Review
        </Link>
      </div>
